...
func (q *Queries) CreateChunks(ctx context.Context, arg []CreateChunksParams) (int64, error) {
	return q.db.CopyFrom(ctx, []string{"code_chunks"}, []string{"symbol_name", "symbol_type", "file_path", "start_line", "end_line", "content", "doc", "embedding", "token_count", "sha256"}, &iteratorForCreateChunks{rows: arg})
}
